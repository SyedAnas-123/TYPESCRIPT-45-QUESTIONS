//ALL GUEST
let Guestlist : string[] =["ANAS","BABA","HASNAIN"]

//print the name who is not invited fro dinner
let unableToAttend : string = Guestlist.splice(0,1)[0] //how many wlements want to delete from index 0
...
Guestlist.forEach(guest =>{
    console.log(`SO DEAR ${guest} YOU ARE INVITED TO DINNNER`); //array ke sb elements pr laga dega ye msg
